...
<div class="block group relative bg-gray-900/50 backdrop-blur-sm rounded-lg overflow-hidden border-2 border-amber-500 hover:border-amber-400 hover:shadow-2xl hover:shadow-amber-500/20 transition-all duration-300 transform hover:-translate-y-1">
    <!-- Code Badge -->
    @if($code)
