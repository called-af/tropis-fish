...
@php
$variants = [
    'outline' => 'border border-amber-500/50 text-amber-500 bg-transparent focus:bg-amber-500/10 focus:border-amber-500 font-light tracking-wide',
...
<div class="w-full">
    ...
    <div class="relative">
        ...
        >
            @if($placeholder)
                <option value="" class="text-amber-500/60">{{ $placeholder }}</option>
            @endif
