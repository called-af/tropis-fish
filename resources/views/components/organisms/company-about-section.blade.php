        ...
        <div class="max-w-7xl mx-auto">
            <div x-data="{ visible: false }" x-intersect:enter="visible = true" x-intersect:leave="visible = false"
                ...
                <div class="space-y-8">
                    {{-- Title --}}
                    <div>
                        <h2 class="text-4xl md:text-5xl font-extrabold text-amber-500 mb-4">{{ $aboutSection->title }}</h2>
                    ...
                    {{-- Text Content --}}
                    <div class="space-y-6">
                        @foreach($aboutSection->content_blocks ?? [] as $block)
                ...
                <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                @foreach($images as $index => $img)
                                    <div
                                        ...
                                        <img src="{{ asset('storage/' . $img['path']) }}" alt="{{ $img['alt'] ?? 'Company Image' }}"
                    ...
                    @else
                            ...
                            [
                                ...
                                :interval="3000" aspect-ratio="aspect-[3/3]" />
                    @endif
                </div>
            </div>
        </div>
