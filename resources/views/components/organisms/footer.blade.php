        ...
        <div class="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <a href="#" class="w-10 h-10 bg-white/20 backdrop-blur-sm hover:bg-white hover:text-amber-600 text-white rounded-lg flex items-center justify-center transition">
