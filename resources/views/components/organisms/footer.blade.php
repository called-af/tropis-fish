        ...
        <div class="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <a href="#products" class="text-white/80 hover:text-white transition">Products</a>
            ...
            <div>
                <h4 class="font-bold text-white mb-4">Information</h4>
                <div class="flex flex-col gap-2">
                    <a href="#" class="text-white/80 hover:text-white transition">How to Order</a>
                    <a href="#" class="text-white/80 hover:text-white transition">Privacy Policy</a>
                    <a href="#" class="text-white/80 hover:text-white transition">Terms & Conditions</a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <a href="#" class="w-10 h-10 bg-white/20 backdrop-blur-sm hover:bg-white hover:text-orange-600 text-white rounded-lg flex items-center justify-center transition">
                ...
                {{-- Note: Social media icons kept as custom SVG since they are brand-specific icons not available in Heroicons --}}
            </div>
        </div>
