        ...
        <div class="max-w-6xl mx-auto">
            <div x-data="{ visible: false }" x-intersect:enter="visible = true"
                ...
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
                    <span class="text-amber-500">Farm</span> Gallery
                </h1>
                <p class="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
                    Explore our state-of-the-art fish farming facilities and operations
                </p>
            </div>
        </div>
    </section>
                ...
                <div class="text-center py-16">
                    <div class="max-w-md mx-auto">
                        <div class="w-20 h-20 mx-auto mb-6 bg-white/5 rounded-full flex items-center justify-center">
                            <x-heroicon-o-building-office-2 class="w-10 h-10 text-gray-500" />
                        </div>
                        <h3 class="text-xl font-semibold text-white mb-2">No Farm Gallery Yet</h3>
                        <p class="text-gray-400">We're preparing images of our farm facilities for you.</p>
                    </div>
                </div>
            @endif
        </div>
