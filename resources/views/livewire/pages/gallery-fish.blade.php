        ...
        <div class="max-w-6xl mx-auto">
            <div x-data="{ visible: false }" x-intersect:enter="visible = true"
                ...
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
                    <span class="text-amber-500">Fish</span> Gallery
                </h1>
                <p class="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
                    Explore our beautiful collection of premium ornamental tropical fish
                </p>
            </div>
        </div>
    </section>
            ...
            @else
                <div class="text-center py-16">
                    <div class="max-w-md mx-auto">
                        ...
                        <h3 class="text-xl font-semibold text-white mb-2">No Fish Gallery Yet</h3>
