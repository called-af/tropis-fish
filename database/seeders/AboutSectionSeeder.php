...
class AboutSectionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        AboutSection::create([
            'title' => 'About Us',
            'description_1' => 'Since 1986, we has been at the forefront of breeding and distributing premium quality ornamental fish. With over two decades of experience, we have established ourselves as one of Indonesia most trusted suppliers of aquatic life.',
